...
if __name__ == '__main__':
    ...
    hp.plotflows(sim, [[8000, 8100], [9300, 9400]], [18000*use_times[0], 18000*use_times[1]], 300, h=.2)

    # ani2 = hp.animatetraj(sim2, siminfo2, usetime=list(range(int(18000*18.25), int(18000*18.75))), show_id=False,
