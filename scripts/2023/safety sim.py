...
offramp1 = hs.Road(num_lanes=1, length=200, name='ann arbor saline off ramp')
offramp1.merge(main_road, self_index=0, new_lane_index=1, self_pos=(0, 150), new_lane_pos=(5330, 5480))
offramp1.connect('exit 2', is_exit=True)
...
offramp2 = hs.Road(num_lanes=1, length=180, name='state off ramp')
offramp2.merge(main_road, self_index=0, new_lane_index=1, self_pos=(0, 130), new_lane_pos=(7810, 7940))
offramp2.connect('exit 3', is_exit=True)
